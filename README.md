...
| Тип запроса                           | RPS        |
|---------------------------------------|------------|
| Публикация поста от лица пользователя | 411,769    |
| Публикация поста от лица сообщества   | 1 742,663  |
| Отправка заявки в друзья              | 73,53      |
| Запрос на обновление ленты            | 8 794,199  |
| Лайк на пост                          | 12 794,236 |
| Комментарий                           | 485,299    |
| Подписка на сообщество                | 73,53      |
| Итого                                 | 24 375,226 |
