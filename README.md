...
- Отдача статического контента: st1-86.vk.com
- Отдача медиаконтента: sun1-XX.userapi.com (где XX - число)
...
Основной домен vk.com, домен для отдачи статического контента st1-86.vk.com будут располагаться в **Москве**. Именно в Москве и вокруг нее находится наибольшая концентрация пользователей. 

Распределение доменов CDN (отдача медиаконтента sun1-XX.userapi.com):
