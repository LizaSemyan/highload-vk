...
- **Feed Service**. Построение новостной ленты;
...
- **Recommendation Service**. Формирование персонализированных рекомендаций на основе векторных представлений и коллаборативной фильтрации. 
