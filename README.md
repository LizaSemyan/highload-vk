...
Вычитывается весь HTTP запрос, исходя из этого перенаправляется на нужный сервер. Будет использоваться **Nginx**. Надежность сопоставима с надежностью железа. Будет использоваться для отдачи статики, сжатия контента.
