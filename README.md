...
- Был проведен анализ небольшого количества пользователей [^16], в среднем у пользователя 76,9 видео, видео хранятся ссылкой на vkvideo. На хранение одной ссылки нужно 100 байт, тогда всего надо 7690 байт=~0,0007 МБ
...
| Опубликованные видео                | ~0,0007 МБ | 76,9       |
