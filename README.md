...
- Размер одного поста с фото 5 КБ (аватарка) + 2252,8 КБ (фотография) + 0,01 КБ (небольшая подпись) = 2257,81 КБ. Постов с фото 64%. 0,64 * 11 095,56 = 7 101,158 млн постов с фото. Это 7 101,158 * 2257,81 = 16 033 065,544 КБ в месяц = 15,29 ГБ в месяц
