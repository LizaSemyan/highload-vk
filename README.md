...
|----------------------|----------------------------------|---------------------------|--------------------|
| **user**             | Cоздание аккаунта                |                           |                    |               
| **post**             | Публикация постов (пользователи) |                           |                    | 
| **post**             | Публикация постов (сообщества)   |                           |                    |
| **friend**           | Добавление в друзья              |                           |                    |
| **friend_request**   | Отправка заявки в друзья         |                           |                    | 
| **user_activity**    | Действия с контентом             |                           |                    |
| **community**        | Создание сообщества              |                           |                    |
| **community_member** | Подписки на сообщества           |                           |                    | 
| **like**             | Лайк на пост                     |                           |                    | 
| **comment**          | Публикация комментария           |                           |                    |   
...
|----------------------|----------------------------------|--------------------------|-------------------|
| **user**             | Просмотр профиля пользователя    |                          |                   |
| **post**             | Просмотры контента постов        |                          |                   |
| **friend**           | Просмотр списка друзей           |                          |                   |
| **friend_request**   | Просмотр списка заявок в друзья  |                          |                   |
| **user_activity**    | Анализ действий пользователя     |                          |                   |
| **community**        | Просмотр сообщества              |                          |                   |
| **community_member** | Просмотр списка подписчиков      |                          |                   |
| **like**             | Просмотр лайков                  |                          |                   |                      
| **comment**          | Чтение комментариев              |                          |                   |
| **recommendation**   |                                  |                          |                   |
