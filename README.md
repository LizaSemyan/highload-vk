...
- **User Service**. Управление учетными записями, профилями пользователей, друзьями, заявками в друзья;
- **Community Service**. Создание и редактирование сообществ, управление участниками;
- **Feed Service**. Построение новостной ленты;
- **Post Service**. Публикация, изменение постов;
