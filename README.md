...
| Итого          | 51 521 | 103 043     | -                     | -     | -        | 198,6         |

| Компонент        | RPS    | Пиковый RPS | CPU   | RAM МБ | Трафик Гбит/с |
|------------------|--------|-------------|-------|--------|---------------|
| Nginx            | 51 521 | 103 043     | 207   | 2070   | 198,6         |
| API Gateway      | 51 521 | 103 043     | 207   | 2070   | 198,6         |

| Название | Хостинг | Конфигурация            | Cores | Cnt | Покупка | Аренда |
|----------|---------|-------------------------|-------|-----|---------|--------|
| nginx    | own     | 24 core CPU             |       | 11  |         |        |

### Хранилища

| Хранилище  | Объем    | RPS     | CPU |
|------------|----------|---------|-----|
| PostgreSQL | 9 257 ГБ | 9 043   |     |
| Cassandra  | 2 070 ТБ | 139 385 |     |
| ClickHouse | 198 ТБ   | 88 206  |     |
| Redis      | 142 ТБ   | 59 521  |     |
| S3         | 1 967 ПБ | 87 183  |     |
