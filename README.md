...
- Ранжировать рекомендованных кандидатов по похожести на то, что нравилось пользователю, и взять срез первых 300 кандидатов
- Получить список пользователей, на которых подписан текущий пользователь
- Получить список сообществ, на которые подписан текущий пользователь

**Итог**: получены 300 релевантных рекомендованных кандидатов, получены подписки на авторов (пользователей и сообщества).

#### Этап 2. Получение постов

**Итог**: получены 5000 постов.

#### Этап 3. Ранжирование

**Итог**: получены 1000 постов.
...
При запросе на получение ленты, пользователю из кэша отдается последний пост из предыдущей сессии (для того чтобы 
