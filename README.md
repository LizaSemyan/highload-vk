...
- Основной домен (точка входа): vk.com
...
Исходя из плотности населения и региональной структуры пользователей, распределение нагрузки на CDN можно оценить следующим образом:
...
| Тип запроса                           | Москва, средний RPS | Санкт-Петербург, средний RPS | Ростов-на-Дону, средний RPS | Екатеринбург, средний RPS | Новосибирск, средний RPS |
|---------------------------------------|---------------------|------------------------------|-----------------------------|---------------------------|-------------------------|
