...
- **Recommendation Service**. Формирование персонализированных рекомендаций на основе векторных представлений и коллаборативной фильтрации. Берет данные из разных таблиц бд для формирования списка рекомендованных авторов (User PostgreSQL, Community PostgreSQL, Comment Cassandra, Like Cassandra, UserActivity ClickHouse);
...
Для API Gateway на 1 CPU: 5000 RPS, 10 Mb RAM

| Компонент      | RPS    | Пиковый RPS | CPU   | RAM      | Трафик Гбит/с |
|----------------|--------|-------------|-------|----------|---------------|
| Nginx          | 51 521 | 103 043     | 207   | 2070 МБ  | 397,2         |
| API Gateway    | 51 521 | 103 043     | 21    | 2070 МБ  | 397,2         |
...
|------------|----------|---------|-------|
| PostgreSQL | 9 257 ГБ | 9 043   | 91    |
| Cassandra  | 2 070 ТБ | 139 385 | 1 394 |
| ClickHouse | 198 ТБ   | 88 206  | 883   |
| Redis      | 142 ТБ   | 59 521  | 596   |
