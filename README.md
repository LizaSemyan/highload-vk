...
| Go                         | Backend                       | |
| React                      | Frontend                      | |
| Nginx                      | Балансировка нагрузки, прокси | |
| Linux Virtual Server       | Балансировка нагрузки         | |
| Kubernetes                 | Оркестрация                   | |
| PostgreSQL                 | Основная бд сервиса           | |
| Cassandra                  | Основная бд сервиса           | |
| ClickHouse                 | Сбор и хранение статистики    | |
| Redis                      | Хранение рекомендаций         | |
| VK Cloud                   | Хранение медиа файлов         | S3 хранилище |
