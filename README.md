...
- Пиковый RPS = Отправка заявки в друзья + Подписка на сообщество = 148 + 148 + 5000000 * 2 / 30 / 86400 = 300
...
- Легкое JSON API: 5000 RPS, 10 Mb RAM
- Средняя бизнес-логика: 100 RPS, 100 Mb RAM
- Тяжелая бизнес-логика: 10 RPS, 100 Mb RAM

| Сервис         | RPS    | Пиковый RPS | Характер сервиса      | CPU   | RAM Mb   | Трафик Гбит/с |
|----------------|--------|-------------|-----------------------|-------|----------|---------------|
| Auth           | 24 598 | 49 197      | Легкое JSON API       | 10    | 100      |               |
| Author         | 150    | 300         | Средняя бизнес-логика | 3     | 300      |               |
| Feed           | 8 794  | 17 588      | Тяжелая бизнес-логика | 1 759 | 175 900  |               |
| Post           | 2 155  | 4 310       | Средняя бизнес-логика | 44    | 4 400    |               |
| Reaction       | 13 279 | 26 558      | Средняя бизнес-логика | 266   | 26 600   |               |
| Recommendation | 735    | 1 470       | Тяжелая бизнес-логика | 147   | 14 700   |               |
| Media          | 1 810  | 3 620       | Средняя бизнес-логика | 37    | 3 700    |               |  

### Хранилища

| Хранилище  | Объем | RPS на запись | RPS на чтение | CPU |
|------------|-------|---------------|---------------|-----|
| PostgreSQL |       |               |               |     |
| Cassandra  |       |               |               |     |
| ClickHouse |       |               |               |     |
