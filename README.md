...
После глобальной балансировки запрос отправляется в датацентр, где начинается локальная балансировка нагрузки. Так как одного L7 балансировщика недостаточно, то локальная балансировка нагрузки будет происходить **каскадно** сначала на L4-уровне, после чего L7-уровне.
